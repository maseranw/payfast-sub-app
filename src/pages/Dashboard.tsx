...
import { CheckCircle, XCircle, Crown, Calendar, CreditCard } from 'lucide-react'
import ReverseText from '../features/ReverseText'
import EmojiBlast from '../features/EmojiBlast'
import { getStatusBadgeConfig } from '../lib/subscription-status'
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-bold text-gray-900 dark:text-white">Subscription Status</h2>
            </div>
            ...
            {subscription ? (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-gray-900 dark:text-white">{subscription.plan?.name}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Status</span>
                  <span className={`text-sm font-bold capitalize ${statusBadge!.colorClassName}`}>
                    {subscription.status}
                  </span>
                </div>
                <div className="flex items-center justify-between">
              ...
              <div className="text-center py-4">
                ...
                <a
                  href="/subscribe"
                  className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-400 transition-colors"
                >
        ...
        <div className="lg:col-span-2">
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-gray-200 dark:border-gray-700">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Feature Access</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              {features.map((feature) => (
                <div key={feature.key} className="p-4 rounded-lg border border-gray-200 dark:border-gray-600">
            ...
            <div className="space-y-6">
              ...
              {!hasFeature('reverse_text') && !hasFeature('emoji_blast') && (
                <div className="text-center py-8">
                  ...
                  <a
                    href="/subscribe"
                    className="inline-flex items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-400 transition-colors"
                  >
                    <Crown className="h-4 w-4 mr-2" />
                    View Plans
                  </a>
